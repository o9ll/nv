...
const BUILT_IN_CATEGORIES: CommandCategory[] = [
    {
        ...
        label: "Quick Actions",
        description: `Common ${BRAND_NAME} shortcuts`
    },
    {
        id: "plugins",
        label: "Plugins",
        description: `Manage ${BRAND_NAME} and Vencord plugins`
    },
    {
    ...
    },
    {
        id: "updates",
        label: "Updates",
        description: `Stay up to date with ${BRAND_NAME}`
    },
    {
        id: "discord-settings",
...
function registerUpdateCommands() {
    registerCommand({
        ...
        description: `Checks for ${BRAND_NAME} updates`,
    ...
    registerCommand({
        ...
        description: `Opens the ${BRAND_NAME} changelog`,
