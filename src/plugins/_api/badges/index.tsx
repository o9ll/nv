...
import { BRAND_BADGES_URL, BRAND_ICON_DATA_URL, BRAND_NAME } from "@shared/branding";
...
const USERPLUGIN_CONTRIBUTOR_BADGE = `data:image/svg+xml;utf8,${encodeURIComponent([
    ...
    '<path d="M22 18h20v10l-4 4 4 4v10H22V36l4-4-4-4Z" fill="#f3f7e7"/>',
    '<circle cx="32" cy="32" r="23" fill="none" stroke="#a7d269" stroke-width="3"/>',
    "</svg>",
].join(""))}`;
...
async function loadAllBadges(noCache = false) {
    ...
    const equicordBadges = await loadBadges(BRAND_BADGES_URL, noCache);
